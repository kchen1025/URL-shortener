...
select * from bulk_order where name = 'aCa4W000000gIF6SAM-1594646708960';
select * from property where bulk_order_id = 152262;
select * from bulk_order_data where bulk_order_id = 152262;